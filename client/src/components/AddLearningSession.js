...
import { addLearningSession } from '../action/doubt'
import PropTypes from 'prop-types'
import Axios from 'axios'
import ReactQuill from 'react-quill'
import 'react-quill/dist/quill.snow.css'

const AddLearningSession = ({addLearningSession}) => {
...
AddLearningSession.propTypes = {
	addLearningSession: PropTypes.func.isRequired
}

// Connecting react program with redux
export default connect(null, {addLearningSession})(AddLearningSession)
